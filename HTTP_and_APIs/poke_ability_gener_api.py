...
class PokeAbilityGeneration:
    ...
    def __init__(self, ability):
        ability_obj = PokeAbilities(ability)
        self.generation = ability_obj.ability_response_json["generation"]["name"]
        self.generation_url = ability_obj.ability_response_json["generation"]["url"]
